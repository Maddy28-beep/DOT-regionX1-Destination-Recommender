    ...
    public function run(): void
    {
        ...
        $destinations = [
            [
                ...
                'location' => 'Babak District, IGACOS',
            ...
            [
                ...
                'location' => 'Kapatagan, Digos, Davao del Sur',
        ...
        $accommodations = [
            ['name' => 'BlueJaz Beach Resort', 'region' => 'Island Garden City of Samal', 'price_per_night' => 3500],
            ['name' => 'Pearl Farm Beach Resort', 'region' => 'Island Garden City of Samal', 'price_per_night' => 8500],
            ['name' => 'Paradise Island Park & Beach Resort', 'region' => 'Island Garden City of Samal', 'price_per_night' => 2800],
        ];
        ...
        $restaurants = [
            ['name' => 'Marina Tuna Restaurant', 'cuisine_type' => 'Filipino Seafood', 'price_tier' => 'Mid-range'],
            ['name' => 'Kublai Khan Mongolian Restaurant', 'cuisine_type' => 'Mongolian & Asian', 'price_tier' => 'Mid-range'],
            ['name' => 'Blue Post Boiling Crabs & Shrimp', 'cuisine_type' => 'Seafood', 'price_tier' => 'Mid-range'],
        ];
        ...
        $souvenirCenters = [
            ['name' => 'Davao Local Products & Souvenir Center'],
            ['name' => 'Aldevinco Shopping Center'],
            ['name' => 'Kadayawan Souvenir Shop'],
        ];
